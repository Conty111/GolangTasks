...
которая объединит слайсы в один отсортированный в два этапа: - отсортировать каждый слайс -
объединить полученные слайсы в один. Кстати, именно так работает алгоритм сортировки слиянием ( merge sort)
Примечания
